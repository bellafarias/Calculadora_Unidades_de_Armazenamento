...
def dadinhos_converter():
    ...
    medidas_final = input("Escolha uma unidade de armazenamento para que o valor seja convertido em relação a lista anterior:")
...
dadinhos_converter()
paradinha = False
while paradinha == False:
    print("\nGostaria de executar novamente o código? Insira 's' para sim ou 'n' para não.")
    repetindo = input()
    if repetindo == 's':
        dadinhos_converter()
    elif repetindo == 'n':
